 ...
 * @since 13/04/2020
 */
class DocenteFinder implements  IAutocompleteFinder {
	...
	public function findEntitiesByText( $text, $parent=null ){
		...
		$uiCriteria = new UIDocenteCriteria();
		$uiCriteria->setNombre( $text );
		$uiCriteria->setRowPerPage( 10 );
		return UIServiceFactory::getUIDocenteService()->getList($uiCriteria);	
	}
	...
	function findEntityByCode( $code, $parent=null ){
		...
		return UIServiceFactory::getUIDocenteService()->get( $code );
	}
	...
	public function getAttributesCallback(){
		return array("oid", "apellido","nombre","documento");		
	}
