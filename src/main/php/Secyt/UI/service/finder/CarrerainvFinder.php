...
/**
 * 
 * Finder para Carrerainv.
 * 
 * @author Marcos
 * @since 09/04/2020
 */
class CarrerainvFinder implements  IAutocompleteFinder {
	...
	public function findEntitiesByText( $text, $parent=null ){
		...
		$uiCriteria = new UICarrerainvCriteria();
		$uiCriteria->setNombre( $text );
		$uiCriteria->setRowPerPage( 10 );
		return UIServiceFactory::getUICarrerainvService()->getList($uiCriteria);	
	}
	...
	function findEntityByCode( $code, $parent=null ){
		...
		return UIServiceFactory::getUICarrerainvService()->get( $code );
	}
