...
/**
 * 
 * Finder para Integrante.
 * 
 * @author Marcos
 * @since 14/04/2020
 */
class IntegranteFinder implements  IAutocompleteFinder {
	...
	public function findEntitiesByText( $text, $parent=null ){
		...
		$uiCriteria = new UIIntegranteCriteria();
		$uiCriteria->setNombre( $text );
		$uiCriteria->setRowPerPage( 10 );
		return UIServiceFactory::getUIIntegranteService()->getList($uiCriteria);	
	}
	...
	function findEntityByCode( $code, $parent=null ){
		...
		return UIServiceFactory::getUIIntegranteService()->get( $code );
	}
	...
	function getEntityLabel( $entity ){
		if( !empty( $entity)  )
		return $entity->getProyectoIntegrante();
	}
