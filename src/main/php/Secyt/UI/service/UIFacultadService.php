...
class UIFacultadService  implements IEntityGridService{
	...
	public static function getInstance() {
		...
		if( self::$instance == null ) {
			...
			self::$instance = new UIFacultadService();
	...
	public function getList( UIFacultadCriteria $uiCriteria){
		...
		try{
			...
			$service = ServiceFactory::getFacultadService();
	...
	public function add( Facultad $facultad ){
