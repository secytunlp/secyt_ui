...
class UIDisciplinaService  implements IEntityGridService{
	...
	public static function getInstance() {
		...
		if( self::$instance == null ) {
			...
			self::$instance = new UIDisciplinaService();
	...
	public function getList( UIDisciplinaCriteria $uiCriteria){
		...
		try{
			...
			$service = ServiceFactory::getDisciplinaService();
	...
	public function add( Disciplina $tipoAcreditacion ){
	...
	public function update( Disciplina $tipoAcreditacion ){
